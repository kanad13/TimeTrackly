# **⏱️ Multi-Task Time Tracker (MTTT)**

The **Multi-Task Time Tracker (MTTT)** is a highly portable, single-file web application for tracking time across multiple hierarchical activities (Project / Task). It provides real-time monitoring, secure data persistence via Firestore, and flexible data export options.
...
2. **Deployment:** Follow the instructions in the [DEPLOYMENT.md](http://docs.google.com/DEPLOYMENT.md) file to quickly deploy this application to your Firebase environment.

## **📝 Detailed Guidance**

For a deep dive into the architecture, design rationale, and the remaining roadmap for integrating AI agents, please refer to the comprehensive [DEVELOPMENT_GUIDE.md](http://docs.google.com/DEVELOPMENT_GUIDE.md).
