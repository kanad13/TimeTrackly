...
- **Notes Feature**:
  - Floating modal dialog (not inline expansion)
  - Click Notes button → modal opens at screen center with task name
  - Explicit Save button required (not auto-save)
  - Close with: Save button, Cancel button, ESC key, or click backdrop
  - Persist when saving timers
...
│ [Resume] [Stop] [Delete] [Notes] ← Button row   │
│                                                  │
│ Notes button opens floating modal dialog        │
│ (centered on screen, independent of scroll)    │
└─────────────────────────────────────────────────┘

Modal (when Notes button clicked):
┌─────────────────────────────────────┐
│ Notes for Task Name        [✕ Close] │
├─────────────────────────────────────┤
│                                     │
│  ┌──────────────────────────────┐  │
│  │ Add notes...    (textarea)   │  │
